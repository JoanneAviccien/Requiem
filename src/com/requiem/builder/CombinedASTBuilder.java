// Alternatif: Buat class yang menggabungkan validation dan building
...
public class CombinedASTBuilder extends RequiemV2BaseListener {
    ...
    private RequiemErrorListener errorListener;

    public CombinedASTBuilder(RequiemErrorListener errorListener) {
