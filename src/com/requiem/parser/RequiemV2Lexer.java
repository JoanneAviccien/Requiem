...
public class RequiemV2Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"FEATURE", "RELEASE", "ASSIGN", "MUST", "SHOULD", "COULD", "WONT", "TITLE", 
			"VALUE", "EFFORT", "RISK", "DEPENDENCIES", "TARGET_DATE", "TEAM_CAPACITY", 
	...
	public RequiemV2Lexer(CharStream input) {
		super(input);
